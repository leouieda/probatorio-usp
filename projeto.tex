...
Ingressei na carreira docente da Universidade de São Paulo no dia 21 de agosto
de 2023.
Previamente, fui Professor Assistente na Universidade do Estado do Rio de
Janeiro (2014 a 2017) e \emph{Lecturer} na University of Liverpool (2019 a
2023).
Minha carreira em acadêmica sempre foi direcionada pelos princípios da
\emph{ciência aberta e inclusiva}, tanto na pesquisa quanto no ensino e
extensão.

Este projeto apresenta meu plano para atividades nas áreas de ensino, pesquisa,
extensão e gestão para os próximos dois anos, entre setembro de 2023 e agosto
de 2025.
