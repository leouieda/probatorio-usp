...
\begin{enumerate}
  ...
  \item \textbf{Organização de um \emph{workshop} sobre software livre na
    geofísica}:
    As comunidades de software livre \href{https://www.fatiando.org/}{Fatiando
    a Terra} (criado e liderado por mim) e \href{https://simpeg.xyz/}{SimPEG}
    ...
    ``\href{https://birs-2023.softwareunderground.org/}{Open-Source Tools to
    Enable Geophysical Data Processing and Inversion}'', na Banff International
    Resarch Station (BIRS). Os objetivos do workshop eram promover a
    colaboração entre os dois projetos e aumentar a conexão entre os
    ...
    trabalhos iniciados no BIRS e para conectar a comunidade geofísica
    brasileira com os dois projetos (por exemplo, do Serviço Geológico do
    Brasil (CPRM), da Vale, do IAG, do Observatório Nacional, etc.). Planejo
    pleitear por auxílio financeiro da FAPESP e de parceiros nos setores
    privado e público para a organização do evento, que poderá ser executado em
    2025.
\end{enumerate}
